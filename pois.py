...
if __name__ == '__main__':
    ...
    for region in centre_map_dict:
        ...
        if region_mapped in region_mapped_count:
            ...
            region_mapped_count[region_mapped] = int(region_pop_dict[region])
    region_p_dict = region_mapped_count#所有用户单位时间内访问该基的概率
